...
public class PlayerManager : MonoBehaviour {
	...
	private List<CARD_DATA> _hand = new List< CARD_DATA >( );   // 手札
	private List<CARD_DATA> _turn = new List< CARD_DATA >( );   // 持続強化カード
	[ SerializeField ]
	...
	public void endStatus( ) {
		_player_data.draw = _plus_draw;
		_player_data.power = _plus_power;
	}
	...
	public void setDefalutStatus( ) {
		_player_data.draw = _defalut_draw;
		_player_data.power = _defalut_power;
	}
